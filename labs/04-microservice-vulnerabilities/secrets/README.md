...
```powershell
kubectl apply -f labs/04-microservice-vulnerabilities/secrets/manifests/secrets.yaml
```
...
```powershell
kubectl delete -f labs/04-microservice-vulnerabilities/secrets/manifests/secrets.yaml
```
